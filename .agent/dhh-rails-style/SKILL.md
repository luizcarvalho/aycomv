...
description: This skill should be used when writing Ruby and Rails code. It applies when writing Ruby code, Rails applications, creating models, controllers, or any Ruby file. Triggers on Ruby/Rails code generation, refactoring requests, code review. Embodies REST purity, fat models, thin controllers, Current attributes, Hotwire patterns, and the "clarity over cleverness" philosophy.
---

<objective>
Apply Rails conventions to Ruby and Rails code. This skill provides comprehensive domain expertise extracted from analyzing production codebases and code review patterns.
</objective>
...
4. **Architecture** - Routing, jobs, caching
...
| 4, architecture, routing, job, cache | [architecture.md](./references/architecture.md) |
...
| [architecture.md](./references/architecture.md) | Routing, jobs, Current attributes, caching, database patterns |
